...
lsf.write_output('Copying startperf script to console.', logfile=lsf.logfile)
lsf.scp('/vpodrepo/2026-labs/2637/startperf.ps1', 'holuser@console:/home/holuser/startperf.ps1', lsf.password)
lsf.write_output('Finished Copying startperf script to console.', logfile=lsf.logfile)
# fail like this
